<template>
    <div class="min-h-screen bg-white text-gray-800">
      ...
      <header class="bg-green-600 text-white py-8 px-6 text-center">
        <h1 class="text-4xl font-bold mb-2">Run Club Guidelines & Community Ethos</h1>
        <p class="text-lg">Supportive, Social, and Stronger Together.</p>
      </header>
      ...
      <section class="py-12 px-6 max-w-5xl mx-auto space-y-10">
        ...
        <!-- Group Guidelines -->
        <div>
          <h2 class="text-2xl font-bold text-green-700 mb-4">👥 Group Guidelines</h2>
          <ul class="list-disc list-inside space-y-2">
        ...
        <div>
          <h2 class="text-2xl font-bold text-green-700 mb-4">🤝 Run Leader Responsibilities</h2>
          <ul class="list-disc list-inside space-y-2">
            <li>Welcome new folks and check in with the group.</li>
            <li>Keep the pace steady and inclusive.</li>
            <li>Loop back often and make sure no one is left behind.</li>
            <li>Ensure someone in the group has a phone for safety.</li>
            <li>Help regroup after crossings or intersections.</li>
          </ul>
        </div>
  
        <!-- Basic Rules -->
        <div>
          <h2 class="text-2xl font-bold text-green-700 mb-4">📌 Basic Rules</h2>
          <ul class="list-disc list-inside space-y-2">
  ...
  <script setup>
  // No script logic needed unless you want to add interactivity
  </script>
